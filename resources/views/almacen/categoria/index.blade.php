                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group mb-6">
                                        ...
                                        <input type="text" class="form-control" name="texto" placeholder="Buscar categorías" value="" aria-label="Recipient's username" aria-describedby="button-addon2">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group mb-6">
                                        ...
                                        <a href="" class="btn btn-success">Nueva</a>
                                    </div>
                                </div>
                            </div>
